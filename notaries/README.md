...
Please note, applications are reviewed on a **biweekly basis (every other Tuesday starting 2020.11.10 at 5pm UTC)** - and will be graded according to this community defined [criteria](/notaries/templates#overview). Edits to the criteria, will follow the same process as any proposed change to this repository, defined [here](/README.md#process-for-modifications).
